...
/*
  Component   : CarCard
  Description : Component for showing each car in the list.
  Params      : CarCardProps
  Requires    : CustomBtn => For `View More` Btn
                CarProps  => Interface for getting `car` details
                calculateCarRent => For calculating car's rent
